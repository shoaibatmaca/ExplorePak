...
public class PaymentActivity extends AppCompatActivity {
    ...
    private static final String PAYMENT_RETURN_URI = "http://localhost:63342/ShahZadAsadFYP/payment.html?_ijt=ii5470lpemei0u4ji3j0uru446&_ij_reload=RELOAD_ON_SAVE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView webView = findViewById(R.id.payement_webview);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Toast.makeText(PaymentActivity.this, "Error: " + description, Toast.LENGTH_SHORT).show();
            }
        ...
        Log.d("PaymentActivity", "Post Data: " + postData); // Log the post data
